    ...
    return (
        <div className='w-[100vw]   bg-white sm:w-18 flex flex-row sm:flex-col '>
            <div className=' w-[100vw] bg-white sm:w-18 md:w-12 md:w-30 ml-3 flex flex-row sm:flex-col justify-between bg-red-400'>
                ...
                {/* Create */}
                <div className='flex  hover:bg-gray-100  cursor-pointer rounded-lg mt-3 justify-center items-center'>
                    {/* You can open the modal using document.getElementById('ID').showModal() method */}
                    <button className="hover:outline-none hover:border-none flex bg-red-500 justify-between gap-4 -ml-3 !bg-transparent" onClick={() => document.getElementById('my_modal_3').showModal()}>
                        <div className='md:mr-0'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="black" className="size-6">
                    ...
                    <dialog id="my_modal_3" className="modal ">
                        <div className="modal-box !bg-white !w-screen sm:!w-[100vw] h-[50%] sm:h-[70%]">
